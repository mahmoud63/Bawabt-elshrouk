!(function(e) {
  ...
  function(e, a, t) {
        ...
        (n = [
          {
            ...
            value: function(e) {
              ...
              if (e instanceof Array) for (var o in e) n[e[o]] && n[e[o]](t);
              else n[e] && n[e](t);
            }
          },
          {
          ...
          },
          {
            ...
            value: function() {
              jQuery('[data-toggle="countTo"]:not(.js-count-to-enabled)').each(
                function(e, a) {
                  var t = jQuery(a),
                    n = t.data('after'),
                    o = t.data('before');
                  ...
                  .on('click.cb.helpers.core', function(e) {
                    ...
                    0 === t.children('.click-ripple').length
                      ...
                      (a = t.children('.click-ripple')).height() ||
                        a.width() ||
                        ((n = Math.max(t.outerWidth(), t.outerHeight())),
                        a.css({ height: n, width: n })),
                      (o = e.pageX - t.offset().left - a.width() / 2),
                      (r = e.pageY - t.offset().top - a.height() / 2),
                      a
                        .css({ top: r + 'px', left: o + 'px' })
                        .addClass('animate');
                  });
              });
            }
            ...
            value: function() {
              ...
              jQuery(
                ...
                n.addClass('js-table-checkable-enabled'),
                  jQuery('thead input:checkbox', n).on(
                    'click.cb.helpers',
                    function(a) {
                      var t = jQuery(a.currentTarget).prop('checked');
                      jQuery('tbody input:checkbox', n).each(function(a, n) {
                        var o = jQuery(n);
                        o.prop('checked', t).change(),
                          e.tableToolscheckRow(o, t);
                      });
                    }
                  ),
                  jQuery('tbody input:checkbox, tbody input + label', n).on(
                    'click.cb.helpers',
                    function(a) {
                      var t = jQuery(a.currentTarget);
                      t.prop('checked')
                        ? jQuery('tbody input:checkbox:checked', n).length ===
                            jQuery('tbody input:checkbox', n).length &&
                          jQuery('thead input:checkbox', n).prop('checked', !0)
                        : jQuery('thead input:checkbox', n).prop('checked', !1),
                  ...
                  jQuery('tbody > tr', n).on('click.cb.helpers', function(a) {
                    if (
                      ...
                      var t = jQuery('input:checkbox', a.currentTarget),
                        o = t.prop('checked');
                      t.prop('checked', !o).change(),
                        e.tableToolscheckRow(t, !o),
                        o
                          ? jQuery('thead input:checkbox', n).prop(
                              'checked',
                              !1
                            )
                          : jQuery('tbody input:checkbox:checked', n).length ===
                      ...
                      .on('resize.cb.helpers', function() {
                        clearTimeout(t),
                          (t = setTimeout(function() {
                            o.getWidth() < 768
                              ? r.addClass('flex-column')
                              : r.removeClass('flex-column');
                          }, 150));
                      })
                  ...
                  n.data('numbers') &&
                    l.each(function(e, a) {
                      ...
                      'all' === n
                        ...
                        : t.append(
                            ' (' +
                              i.filter('[data-category="' + n + '"]').length +
                              ')'
                          );
                    }),
                  l.on('click.cb.helpers', function(e) {
                    ...
                    return (
                      t.hasClass('active') ||
                        ...
                        t.addClass('active'),
                        'all' === (a = t.data('category-link'))
                          ? i.filter(':visible').length
                            ? i.filter(':visible').fadeOut(s, function() {
                                i.fadeIn(s);
                              })
                            : i.fadeIn(s)
                          : i.filter(':visible').length
          ...
          },
          {
            ...
            value: function() {
              jQuery(
                '[data-toggle="slimscroll"]:not(.js-slimscroll-enabled)'
              ).each(function(e, a) {
                var t = jQuery(a);
                t.addClass('js-slimscroll-enabled').slimScroll({
                  ...
                  railOpacity: t.data('rail-opacity') || 0.3
                });
              });
            }
          },
          ...
          },
          {
            key: 'tagsInputs',
            value: function() {
              jQuery('.js-tags-input:not(.js-tags-input-enabled)').each(
                function(e, a) {
                  var t = jQuery(a);
          ...
          },
          {
            ...
            value: function() {
              jQuery(
                '.js-draggable-items:not(.js-draggable-items-enabled)'
              ).each(function(e, a) {
                jQuery(a)
        ...
        (t = [
                    ...
                    .on('resize.cb.main orientationchange.cb.main', function(
                      ...
                      clearTimeout(e),
                        (e = setTimeout(function(e) {
                          ...
                          a._lPage.hasClass('page-header-fixed') ||
                          a._lPage.hasClass('page-header-glass')
                            ? a._lMain.css('min-height', t - o)
                            : a._lMain.css('min-height', t - n - o),
                            a._lFooter.fadeTo(1e3, 1);
                        }, 150));
                    })
            ...
            value: function() {
              ...
              jQuery(window).off('scroll.cb.header'),
                e._lPage.hasClass('page-header-glass') &&
                  ...
                  jQuery(window)
                    .on('scroll.cb.header', function(a) {
                    ...
                    return (
                      n.hasClass('open')
                        ...
                        : (t
                            ...
                            .removeClass('open'),
                          n.addClass('open')),
                      e._lHtml.hasClass('no-focus') && t.blur(),
                      !1
                    );
                  }
                );
            ...
            value: function() {
              jQuery('.form-material.floating > .form-control').each(function(
                ...
                setTimeout(function(e) {
                  ...
                  t.off('change.cb.inputs').on('change.cb.inputs', function(e) {
                ...
                this._lPage.on(
                  ...
                  function(t) {
                    ...
                    jQuery('[data-toggle="theme"]')
                      .parent('li')
                      .removeClass('active'),
                      jQuery('[data-toggle="theme"][data-theme="' + r + '"]')
                        .parent('li')
                        .addClass('active'),
                      o.updateTheme(e, r),
                      (e = jQuery('#css-theme')),
                      a && Cookies.set('cbThemeName', r, { expires: 7 }),
                      n.blur();
                  }
                );
            }
          },
          {
            ...
            value: function() {
              ...
              var t = {
                init: function() {
                  a._lPage.off('click.cb.layout'),
                    a._lPage.off('click.cb.overlay'),
                    a._lPage.on(
                      'click.cb.layout',
                      '[data-toggle="layout"]',
                      function(e) {
                    ...
                    a._lPage.hasClass('enable-page-overlay') &&
                      ...
                      jQuery('#page-overlay').on('click.cb.overlay', function(
                        e
                      ) {
                ...
                header_style_modern: function() {
                  a._lPage
                    .removeClass('page-header-glass page-header-inverse')
                    .addClass('page-header-modern'),
                    a._uiHandleHeader(),
                    a._uiHandleMain();
                },
                header_style_classic: function() {
                  a._lPage.removeClass('page-header-glass page-header-modern'),
                    a._uiHandleHeader(),
                    a._uiHandleMain();
                },
                ...
                header_style_inverse_toggle: function() {
                  a._lPage.hasClass('page-header-modern') ||
                    a._lPage.toggleClass('page-header-inverse');
                },
                header_style_inverse_on: function() {
                  a._lPage.hasClass('page-header-modern') ||
                    a._lPage.addClass('page-header-inverse');
                },
                header_style_inverse_off: function() {
                  a._lPage.hasClass('page-header-modern') ||
                    a._lPage.removeClass('page-header-inverse');
                },
                header_search_on: function() {
                  a._lHeaderSearch.addClass('show'),
                    a._lHeaderSearchInput.focus(),
                    jQuery(document).on('keydown.cb.header.search', function(
                      e
                    ) {
                      27 === e.which &&
                        (e.preventDefault(),
          ...
          },
          {
            ...
            value: function() {
              ...
              'init' === r
                ? u[r]()
                : (e = o instanceof jQuery ? o : jQuery(o)).length &&
                  ((a = jQuery(
                    '[data-toggle="block-option"][data-action="fullscreen_toggle"]',
                    e
                  )),
    ...
    function d(e, a) {
      return !a || ('object' !== c(a) && 'function' != typeof a)
        ? (function(e) {
            if (void 0 === e)
