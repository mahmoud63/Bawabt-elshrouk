        ...
        (a = [
          {
            ...
            value: function() {
              ...
              var e = jQuery('.js-chartjs-dashboard-lines'),
                r = jQuery('.js-chartjs-dashboard-lines2');
              e.length &&
                new Chart(e, {
                  type: 'line',
                  data: {
            ...
            value: function() {
              jQuery('#modal-onboarding').modal('show'),
                jQuery('#modal-onboarding').on('shown.bs.modal', function(e) {
                  jQuery('js-slider', '#modal-onboarding').removeClass(
                    'js-slider-enabled'
                  ),
          ...
          },
          {
            key: 'init',
            value: function() {
              this.initDashboardChartJS(), this.initOnboardingModal();
            }
          }
        ]),
        (t = null) && o(r.prototype, t),
        a && o(r, a),
        e
      );
    })();
